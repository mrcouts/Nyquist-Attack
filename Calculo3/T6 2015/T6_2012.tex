...
\begin{equation}
\therefore \iiint_{R} div(\vec{F}) \,dx \,dy \,dz = \frac{64 \sqrt{2} \pi}{3}
\label{eq:3}
\end{equation} \\

Substituindo (\ref{eq:2}) e (\ref{eq:3}) em (\ref{eq:1}):

\[ \iint_{S} \vec{F}  \vec{N} \,dS = - 0 + \frac{64 \sqrt{2} \pi}{3} = \frac{64 \sqrt{2} \pi}{3}  \]
...
\[ \therefore \int_{\gamma} \vec{F} \cdot d\vec{r} = 2\pi \]
	...
	\item[(b)] O campo não é conservativo, pois no item $(a)$ calculamos a integral de linha de $\vec{F}$ em uma curva fechada e o resultado foi dirente de zero.
