...
R = Serial("RRP", '', Matrix([['x','x','x','0'],['y','y','y','x']]).T)
mot = Motor("mot",'5')
mot2 = Motor("mot2",'6')
...
phi_ = po_ - Matrix([R.vw_[0][0]+symbols('beta')*ph_[1],0,0,R.vv_[0][0],R.vv_[0][1],R.vv_[0][2], R.vw_[1][0]+symbols('gamma')*ph_[2],0,0,R.vv_[1][0],R.vv_[1][1],R.vv_[1][2]]).subs(R.StaticBal)
